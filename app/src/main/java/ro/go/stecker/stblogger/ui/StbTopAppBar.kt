            ...
            SearchBarDefaults.InputField(
                ...
                onSearch = {
                    coroutineScope.launch {
                        viewModel.showFilteredTrips(true, viewModel.searchTrips(textFieldState.text.toString()))
                        Log.w("test", viewModel.searchTrips(textFieldState.text.toString()).toString())
